...
//             <span className="portfolio__project-title">Static site</span>
//             <span className="portfolio__project-icon"></span>
//           </a>
//         </li>
//         <li className="portfolio__item">
//           <a
//             href="https://github.com/TikhonovaKs/russian-travel.git"
//             className="portfolio__project-link"
//             target="_blank"
//           >
//             <span className="portfolio__project-title">Responsive website</span>
//             <span className="portfolio__project-icon"></span>
//           </a>
//         </li>
//         <li className="portfolio__item">
...
//             target="_blank"
//           >
//             <span className="portfolio__project-title">Single Page Application</span>
//             <span className="portfolio__project-icon"></span>
//           </a>
//         </li>
//       </ul>
